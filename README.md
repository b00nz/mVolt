...
Windows tuning utility for NVIDIA GeForce RTX 50-series GPUs.

## Download

Download the latest `mVolt+.exe` from [GitHub Releases](../../releases/latest) 
or click here: [mVolt+.exe](https://github.com/b00nz/mVolt/releases/download/v0.3/mVolt+.exe)
...
Other GPU models are currently unverified.
